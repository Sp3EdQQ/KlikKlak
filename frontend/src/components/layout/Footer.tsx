            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center gap-2 mb-4">
                            <Logo className='h-8 w-8 aspect-square' />
                            <span className="text-xl font-bold text-gray-900">KlikKlak</span>
                        </div>
                        <p className="text-gray-500 mb-4 max-w-sm">
                            Twój zaufany sklep z komputerami i komponentami. Budujemy marzenia, jeden komponent na raz.
                        </p>
                        <div className="flex gap-3">
                            <a
                                href="#"
                                className="flex h-9 w-9 items-center justify-center rounded-lg border border-gray-200 bg-white transition-colors hover:bg-blue-50 hover:border-blue-500"
                            >
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a href="#" className="text-gray-500 transition-colors hover:text-blue-500">
                                    Wszystkie produkty
                                </a>
                            </li>
                            <li>
                ...
                <div className="mt-12 border-t border-gray-200 pt-8">
                    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div>
                            <h4 className="mb-1 font-semibold text-gray-900">Zapisz się na newsletter</h4>
